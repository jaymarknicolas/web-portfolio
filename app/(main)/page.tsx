...
export default function Home() {
  return (
    <div className="container mx-auto ">
      ...
      <div className="grid grid-cols-7 gap-x-5 h-[328px]">
        <div className="col-span-3 bg-primary rounded-2xl p-8 flex flex-col justify-between">
        ...
        <div className="col-span-4 bg-[#C5FF41] rounded-2xl p-8 flex flex-col justify-between">
          <div className="space-y-8">
